...
export function UpdatePrompt() {
  ...
  return (
    <div
      role="status"
      className="fixed inset-x-3 top-[calc(env(safe-area-inset-top)+0.75rem)] z-50 mx-auto flex max-w-md items-center gap-3 rounded-2xl border bg-background p-3 pl-4 text-sm shadow-2xl lg:top-auto lg:right-6 lg:bottom-6 lg:left-auto lg:mx-0"
    >
